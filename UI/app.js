...
function init() {
    ...
    dz.on("complete", function (file) {
        ...
        $.post(url, {
            ...
            /* 
            Below is a sample response if you have two faces in an image lets say zayn and roger together.
            ...
            */
            ...
            let celebrity = ["finn_wolfhard", "nina_dobrev", "noah_centineo", "robert_pattinson", "zayn_malik"];
